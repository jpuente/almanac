...
\begin{figure}[h]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=0.7]{labo1}\\
...
\begin{figure}[h]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=0.7]{labo2}\\
...
\begin{figure}[h]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=0.7]{labo3Nuevo}\\
...
\begin{figure}[h]
  \centering\includegraphics[scale=0.7]{labo4}\\
...
\begin{figure}[h]
  \centering\includegraphics[scale=0.6]{intel2}\\
...
\begin{figure}[hbtp]
  \centering\includegraphics[scale=0.6]{intel3}\\
...
\begin{figure}[hbtp]
  \centering\includegraphics[scale=0.45]{intelOdom}\\
...
\begin{figure}[hbtp]
  \centering\includegraphics[scale=0.3]{intelRadish}\\
...
\paragraph{Resultados:}
\begin{figure}[h]
  \centering\includegraphics[scale=0.4]{val3}\\
...
\begin{figure}[hbt]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=0.9]{LaboReal1}\\
...
\begin{figure}[hbt]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=0.8]{LaboReal2}\\
  \caption{Segundo experimento en el laboratorio con robot real}\label{fg:LaboReal2}
\end{figure}

\begin{figure}[hbt]
  % Requires \usepackage{graphicx}
  \centering\includegraphics[scale=1.2]{LaboRealMalo}\\
