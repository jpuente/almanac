...
\section{La clase \prog{CControl3GUIDlg}}
...
Como ya se ha visto, en este modo de funcionamiento no se realiza localización del robot por no haber disponibilidad de medidas del láser. Sin embargo, sí que permite evaluar la deformación de trayectorias en entornos densos en obstáculos mediante el uso de mapas.

\subsubsection{Deformación de trayectorias ante los obstáculos definidos por los puntos de un mapa}
...
\begin{figure}[h]
  ...
  \hspace{0.5cm}\includegraphics[scale=0.4]{reactivo2}
