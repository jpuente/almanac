...
En el caso del Pioneer 3AT la puesta en funcionamiento se ha basado en comunicación con cable serie entre un computador portátil y el robot. El software proporcionado por los fabricantes de este robot permite una conexión similar a la anterior con un simulador accesible a través del puerto TCP 8101.
...
En las figuras \ref{fg:arq1}, \ref{fg:arq2} y \ref{fg:arq3} se muestran los esquemas de distribución de estas posibles configuraciones.

Para más información acerca de los robots y del resto de hardware utilizado puede consultarse el Anexo \ref{ap:hardware}.

\begin{figure}[h]
  \centering\includegraphics[scale=0.85]{arq1}
  \caption{Diagrama de distribución en la utilización del robot Urbano}\label{fg:arq1}
\end{figure}

\begin{figure}[h]
  \centering\includegraphics[scale=0.85]{arq2}
  \caption{Diagrama de distribución en la utilización del robot P3AT}\label{fg:arq2}
\end{figure}

\begin{figure}[h]
  \centering\includegraphics[scale=0.85]{arq3}
  \caption{Diagrama de distribución en la utilización del simulador del P3AT}\label{fg:arq3}
\end{figure}
