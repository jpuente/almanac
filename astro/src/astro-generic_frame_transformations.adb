...
-- Astronomical Almanac, ch. 3 (1992)  (ESAA)                        --
-----------------------------------------------------------------------
...
package body Astro.Generic_Frame_Transformations is
   ...
   begin
      ...
      P := ((Cos (Z_A) * Cos (Theta_A) * Cos (Zeta_A)
               - Sin (Z_A) * Sin (Zeta_A),
            -Cos (Z_A) * Cos (Theta_A) * Sin (Zeta_A)
               - Sin (Z_A) * Cos (Zeta_A),
                  -Cos (Z_A) * Sin (Theta_A)),

            (Sin (Z_A) * Cos (Theta_A) * Cos (Zeta_A)
               + Cos (Z_A) * Sin (Zeta_A),
                  -Sin (Z_A) * Cos (Theta_A) * Sin (Zeta_A)
               + Cos (Z_A) * Cos (Zeta_A),
                  -Sin (Z_A) * Sin (Theta_A)),
